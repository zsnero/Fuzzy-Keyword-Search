...
<!--      <a href="index.jsp" class="btn btn-primary pull-right"  target="_blank" rel="noopener noreferrer" style="opacity:0.9; text-decoration: none;" >LOG OUT</a> 
...
<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="viewusers.jsp" type="button" class="button btn" style="background-color:#d89c46"> View User Account </a><br>

<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<a href="viewfiles.jsp" type="button" class="button btn" style="background-color:#d89c46"> View Files </a><br>
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<a href="uploadpage.jsp" type="button" class="button btn" style="background-color:#d89c46""> Upload File </a><br>
<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

<a href="passwordreset.jsp" type="button" class="button btn" style="background-color:#d89c46"> Password Reset </a>   </div>
  </td>
  <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <div class="s130">
