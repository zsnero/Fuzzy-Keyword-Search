...
/* opacity: 0.9; */
  ...
  <body>  
    ...
    <div class="abc" align="right"  > 
     <a href="#" class="btn btn-primary"  target="_blank" rel="noopener noreferrer"  style="opacity:0.9; background-color:#463f1e;" > HOME</a> &nbsp;&nbsp;&nbsp;
     <a href="#" class="btn btn-primary pull-right"  target="_blank" rel="noopener noreferrer" align="right" style="opacity:0.9; background-color:#463f1e;" >LOG OUT</a> 
